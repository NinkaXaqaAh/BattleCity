...
bool Game::init() {
    ...
    auto pTanksAnimatedSprite = ResourceManager::loadAnimatedSprite("TanksAnimatedSprite", "TanksTextureAtlas", "SpriteShader", 50, 50, "tankTop1");
    ...
    // Инициализация самого танка
	m_pTank = std::make_unique<Tank>(pTanksAnimatedSprite, 0.00000009f, glm::vec2(100.f, 100.f));
